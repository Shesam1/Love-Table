...
class InterestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post interests_url, params: { interest: { comment: @interest.comment, rating: @interest.rating } }
    end
  ...
  test "should update interest" do
    patch interest_url(@interest), params: { interest: { comment: @interest.comment, rating: @interest.rating } }
